...
#define turag_internal_errorf(format, ...) \
    turag_debug_printf_impl(TURAG_DEBUG_LINE_PREFIX TURAG_INTERNAL_LOG_SOURCE TURAG_DEBUG_ERROR_PREFIX format TURAG_DEBUG_NEWLINE, ##__VA_ARGS__)
...
# define turag_internal_warningf(format, ...) \
    turag_debug_printf_impl(TURAG_DEBUG_LINE_PREFIX TURAG_INTERNAL_LOG_SOURCE TURAG_DEBUG_WARN_PREFIX format TURAG_DEBUG_NEWLINE,  ##__VA_ARGS__)
...
#else
# define turag_internal_warningf(format, ...) TURAG_MACRO_NOOP
