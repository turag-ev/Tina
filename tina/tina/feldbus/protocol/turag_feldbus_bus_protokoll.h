...
#ifndef TINA_FELDBUS_PROTOCOL_TURAG_FELDBUS_BUS_PROTOKOLL_H
#define TINA_FELDBUS_PROTOCOL_TURAG_FELDBUS_BUS_PROTOKOLL_H
...
#endif // TINA_FELDBUS_PROTOCOL_TURAG_FELDBUS_BUS_PROTOKOLL_H
