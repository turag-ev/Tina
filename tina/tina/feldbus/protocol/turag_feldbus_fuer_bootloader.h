 ...
 * @{
 */
#define TURAG_FELDBUS_BOOTLOADER_ATMEGA_GET_PAGE_SIZE			0x11
#define TURAG_FELDBUS_BOOTLOADER_ATMEGA_GET_FUSES				0x12
#define TURAG_FELDBUS_BOOTLOADER_ATMEGA_GET_FLASH_SIZE			0x13
 ...
 * @{
 */
#define TURAG_FELDBUS_BOOTLOADER_XMEGA_GET_PAGE_SIZE			0x11
#define TURAG_FELDBUS_BOOTLOADER_XMEGA_GET_FUSES				0x12
#define TURAG_FELDBUS_BOOTLOADER_XMEGA_GET_FLASH_SIZE			0x13
#define TURAG_FELDBUS_BOOTLOADER_XMEGA_GET_REVISION				0x14
#define TURAG_FELDBUS_BOOTLOADER_XMEGA_PAGE_WRITE				0xAA
#define TURAG_FELDBUS_BOOTLOADER_XMEGA_DATA_READ				0xAB


#define TURAG_FELDBUS_BOOTLOADER_XMEGA_RESPONSE_SUCCESS			0x00
#define TURAG_FELDBUS_BOOTLOADER_XMEGA_RESPONSE_FAIL_SIZE		0xFA
#define TURAG_FELDBUS_BOOTLOADER_XMEGA_RESPONSE_FAIL_ADDRESS	0xFB
#define TURAG_FELDBUS_BOOTLOADER_XMEGA_RESPONSE_FAIL_CONTENT	0xFD
///@}
