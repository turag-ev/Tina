...
#define TURAG_FELDBUS_BOOTLOADER_COMMAND_GET_PAGE_SIZE			0x13
#define TURAG_FELDBUS_BOOTLOADER_COMMAND_GET_INFO				0x14
...
#define TURAG_FELDBUS_BOOTLOADER_COMMAND_DATA_READ				0xAB
 ...
 * @{
 */
#define TURAG_FELDBUS_BOOTLOADER_RESPONSE_SUCCESS				0x00
#define TURAG_FELDBUS_BOOTLOADER_RESPONSE_PAGE_FAIL_SIZE		0xFA
#define TURAG_FELDBUS_BOOTLOADER_RESPONSE_PAGE_FAIL_ADDRESS		0xFB
#define TURAG_FELDBUS_BOOTLOADER_RESPONSE_PAGE_FAIL_CHECKSUM	0xFC
#define TURAG_FELDBUS_BOOTLOADER_RESPONSE_PAGE_FAIL_CONTENT		0xFD
///@}
