 ...
 * 
 * @brief Sample feldbus config header for a slave device. Copy this file to your device's source and adjust to your needs.
 * 
 ...
 * is not available.
 * 
 * The following paragraphs contain listins of possible 
 ...
 * 
 * Possible values:
 * - TURAG_FELDBUS_DEVICE_PROTOCOL_STELLANTRIEBE
 * - TURAG_FELDBUS_DEVICE_PROTOCOL_LOKALISIERUNGSSENSOREN
 * - TURAG_FELDBUS_DEVICE_PROTOCOL_ASEB	
 * - TURAG_FELDBUS_DEVICE_PROTOCOL_BOOTLOADER
 */
 ...
 * 
 * Possible values:
 * - TURAG_FELDBUS_CHECKSUM_XOR
 * - TURAG_FELDBUS_CHECKSUM_CRC8_ICODE
 */
