...
#if TURAG_CRC_CRC8_ALGORITHM == 2 && !TURAG_CRC_INLINED_CALCULATION
uint8_t turag_crc8_calculate(const void* data_, size_t length) {
	uint8_t crc = 0xfd;
	uint8_t i;
    uint8_t bit;
    uint8_t c;
...
/**
 * Const data table used for the mixed implementation.
 *****************************************************************************/
const uint8_t turag_crc_crc8_table[16] = {
    0x00, 0x1d, 0x3a, 0x27, 0x74, 0x69, 0x4e, 0x53, 0xe8, 0xf5, 0xd2, 0xcf, 0x9c, 0x81, 0xa6, 0xbb
};
 ...
 * Const data table used for the table_driven implementation.
 *****************************************************************************/
const uint8_t turag_crc_crc8_mow_table[256] = {
...
#if TURAG_CRC_CRC8_MOW_ALGORITHM == 2 && !TURAG_CRC_INLINED_CALCULATION
...
#if TURAG_CRC_CRC16_ALGORITHM == 2 && !TURAG_CRC_INLINED_CALCULATION
uint16_t turag_crc16_calculate_direct(const void* data, unsigned size) {
	// preload checksum
