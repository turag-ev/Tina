#ifndef PLATFORM_CHIBIOS3_PUBLIC_TINAPP_FELDBUS_DRIVER_H
#define PLATFORM_CHIBIOS3_PUBLIC_TINAPP_FELDBUS_DRIVER_H
...
#endif // PLATFORM_CHIBIOS3_PUBLIC_TINAPP_FELDBUS_DRIVER_H
